...
#     nmbr = nmbr*1000/254
#     if nmbr == 0:
#         return "le nombre est égal à 0"
#     elif nmbr > 0:
#         return f"le nombre est positif de valeur {nmbr}"
#     else:
#         return "le nombre est négatif"

# print(condition(float(input("donner un nombre?"))))


# def condition(modulonbr):
#     modulonbr = condition(nmbr)
#     if modulonbr == 1:
#      return "Il est impaire"
#     else:
#         return "Il est pair"
